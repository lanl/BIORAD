...
//////////////////////////////////////////////////////////////////////////////////////////////
template <class T>
void broadcast(T &m_obj, const int &m_src_rank, MPI_Comm m_comm = MPI_COMM_WORLD)
{
	size_t len = (mpi_rank == m_src_rank) ? mpi_size(m_obj) : 0;
	
	MPI_Bcast(&len, sizeof(len), MPI_BYTE, m_src_rank, m_comm);
	...
	while(len > 0){
		...
		MPI_Bcast(ptr, curr_len, MPI_BYTE, m_src_rank, m_comm);
